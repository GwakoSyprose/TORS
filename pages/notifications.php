...
$getdate = $result['not_date'];
 ...
 $query=mysqli_query($link, "SELECT notifications.notificationID,notifications.numPlate,
                  ...
                  WHERE notifications.regionID='$region' AND notifications.stationID='$station'
