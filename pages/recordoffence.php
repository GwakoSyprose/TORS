        ...
        $sql2 = "SELECT SUM(ot.value) offenceCount FROM offences off 
          ...
          if(mysqli_query($link, $sql3)){
           ...
           $sql_update = "UPDATE drivers AS dest,(
            ...
            FROM offence_types INNER JOIN `offences` 
            ON offence_types.`otID` = `offences`.`offenceType`
           GROUP BY offences.`driverID`
            ) AS src SET dest.`fine` = src.penalty
             WHERE dest.`driverID` = src.driverID AND dest.`driverID` = '$id' ;";
                                    ...
                                    <li class="list-group-item p-3">
                                        <div class="row">
                                            <div class="col">
                                                <form role="form" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="comment"><b>
                                                        Select an offense</b></label><br>

                                                <select name="offense[]"
                                                 class="custom-select" multiple="multiple" required>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="KAP-506Z" 
                                                name="numplate" required>
                                            </div>
                                            <script type="text/javascript">
                                                $(document).ready(function() {
